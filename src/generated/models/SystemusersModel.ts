...
export interface SystemusersBase {
  ...
  salutation?: string;
  "sample_StakeholdersId@odata.bind"?: string;
  "sample_TeammemberId@odata.bind"?: string;
  setupuser: boolean;
...
export interface Systemusers extends SystemusersBase {
  ...
  queueidname?: string;
  sample_stakeholdersidname?: string;
  sample_teammemberidname?: string;
  ...
  sample_stakeholdersid?: object;
  _sample_stakeholdersid_value?: string;
  sample_teammemberid?: object;
  _sample_teammemberid_value?: string;
  territoryid?: object;
